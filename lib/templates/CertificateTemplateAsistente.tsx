...
export const CertificateTemplate = ({ data }: CertificateTemplateProps) => {
  ...
  const curso = data.curso || "Metodología de la Investigación Educativa";
        ...
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="ml-36 flex flex-col justify-center text-center text-black">
            ...
            <div className="flex justify-center mt-1">
              <p className="max-w-[670px] text-lg font-semibold">La Secretaría de Educación, Ciencia, Tecnología e Innovación, a través de la Escuela Normal de Sultepec, otorga la presente:</p>
            </div>
            ...
            <div className="flex justify-center text-center">
              <div className="flex flex-col w-full max-w-[600px] mt-2">
                ...
                <p className="text-base text-justify mt-5">
                  Por su destacada participación como <span className="underline">asistente</span> en el Curso-Taller virtual{" "}
                  <span className="font-bold">"{curso}"</span>, con una duración de{" "}
                  <span className="font-semibold">{data.horas || "25"}</span> horas efectivas de trabajo, dirigido a docentes
                  investigadores de la Unidad Regional de Investigación e Innovación Educativa, Región Surponiente.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="h-full flex flex-col justify-between">
            ...
            <div class="ml-36 flex flex-col justify-center text-center text-black">
              ...
              <div class="flex justify-center mt-1">
                <p class="max-w-[670px] text-lg font-semibold">La Secretaría de Educación, Ciencia, Tecnología e Innovación, a través de la Escuela Normal de Sultepec, otorga la presente:</p>
              </div>
              <div class="flex justify-center text-center">
                <div class="flex flex-col w-full max-w-[600px] mt-2">
                  ...
                  <p class="${nombre.length > 30 ? 'text-2xl' : 'text-3xl'} font-bold">${nombre}</p>
                  <div class="mt-3 h-[9px] w-full bg-[#BC955C] bg-gradient-to-r from-[#BC955C] to-white"></div>
                  <p class="text-base text-justify mt-5">
                    Por su destacada participación como <span class="underline">asistente</span> en el Curso-Taller virtual
                    <span class="font-bold">"${curso}"</span>, con una duración de
                    <span class="font-semibold">${data.horas || "25"}</span> horas efectivas de trabajo, dirigido a docentes
                    investigadores de la Unidad Regional de Investigación e Innovación Educativa, Región Surponiente.
                  </p>
                </div>
              </div>
            ...
            <footer class="relative ml-3 flex justify-around items-end">
              ...
              <div class="relative px-3 flex flex-col justify-center text-center items-center text-black">
                ...
                <p class="text-base font-bold">Mtro. Rafael Rodríguez Albíter</p>
