            ...
            <div className="flex justify-center text-center">
              <div className="flex flex-col w-full max-w-[600px] mt-2">
                ...
                <p className="text-base text-justify mt-5">
                  Por su destacada participación como <span className="underline">ponente</span> en el Curso-Taller virtual{" "}
              ...
              <div class="flex justify-center text-center">
                <div class="flex flex-col w-full max-w-[600px] mt-2">
                  ...
                  <p class="text-base text-justify mt-5">
                    Por su destacada participación como <span class="underline">ponente</span> en el Curso-Taller virtual
