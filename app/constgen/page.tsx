...
export default function ConstanciaPage() {
    ...
    return (
        <div
            className="min-h-screen bg-[#4a1324] py-12 px-4 sm:px-6 lg:px-8"
        ...
        >
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <header className="text-center">
                    <h1 className="text-4xl font-bold text-white mb-2">Generador de Constancias</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-4 bg-white rounded-xl shadow-xl p-8 border-t-[5px] border-[#d5b981]">
...
function ImportedCertificatesPanel({
    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow border-t-[5px] border-[#d5b981]">
            {/* Cabecera del panel */}
                ...
                <div className="flex gap-2">
                    {viewMode === 'batch' && (
                        <button
                            ...
                            className="bg-[#691c32] text-white px-4 py-2 rounded hover:bg-[#4a1324] disabled:opacity-50 transition-colors"
                        >
                    ...
                    <button
                        ...
                        className="text-[#691c32] hover:text-[#4a1324] font-medium px-3 py-2"
                    >
            ...
            {uploadResults.length > 0 && (
                <div className="mb-4">
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                            className="bg-[#d5b981] h-2.5 rounded-full transition-all duration-300"
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                                            <div className="flex items-center gap-3">
                                                <button
                                                    className="text-[#691c32] hover:text-[#4a1324]"
        ...
        <button
            ...
            className={`
                ...
                ${isUploading
                    ...
                    : 'bg-[#691c32] hover:bg-[#4a1324] border-2 border-[#d5b981]'}
            `}
        >
